...
const EditStore = ({ order_list, status, store_name }) => {
    ...
    const handleButtonClick = (e, actionType) => {
        e.preventDefault();
        Swal.fire({
            title: `<p class="font-nunito-sans">Are you sure that you want to <span style="color: ${
                actionType === "Close" ? "#309fb5" : "#10B981"
            };">${
                actionType === "Close" ? "CLOSE" : "CANCEL"
            }</span> this?</p>`,
            ...
            if (result.isConfirmed) {
                try {
                    await axios.post("/bto_order_list/edit_save", {
                        action: actionType,
                    ...
                    handleToast(
                        actionType === "Close"
                            ...
                            : "Order Cancelled!",
                        actionType === "Close" ? "success" : "error"
                    );
                } catch (error) {
                    console.log(error);
                }
